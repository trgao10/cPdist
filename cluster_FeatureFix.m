...
TextureCoords1_path = [pwd '/results/Teeth/cPComposedLASTmean/FeatureFixOff/TextureCoords1/'];
TextureCoords2_path = [pwd '/results/Teeth/cPComposedLASTmean/FeatureFixOff/TextureCoords2/'];
