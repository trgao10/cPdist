...
TextureCoords1_path = [pwd '/results/Teeth/cPLASTbalance/FeatureFixOff/TextureCoords1/'];
TextureCoords2_path = [pwd '/results/Teeth/cPLASTbalance/FeatureFixOff/TextureCoords2/'];
